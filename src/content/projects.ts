...
export const projects: Project[] = [
  { slug: 'lac', watchUrl: '', title: 'LẠC', category: 'Stop Motion / Film', disciplines: ['film'], featured: true, art: 'light', cover: { src: '/projects/lac/cover.webp', alt: 'Khung hình stop-motion của phim LẠC', width: 1571, height: 1080 }, summary: 'A careful study of light, one frame at a time.', description: 'A stop-motion film with a strong focus on lighting and carefully executed production.',
  ...
  { slug: 'co-sac', watchUrl: '', title: 'CỔ SẮC', category: 'Documentary / Film', disciplines: ['film'], roles: ['D.O.P', 'Camera Operator'], featured: true, art: 'red', cover: { src: '/projects/co-sac/cover.webp', alt: 'Ảnh bìa phim tài liệu CỔ SẮC', width: 1571, height: 1080 }, summary: 'A documentary seen through a cinematographer’s lens.', description: 'A documentary film with Triệu Phi working as D.O.P and Camera Operator.',
